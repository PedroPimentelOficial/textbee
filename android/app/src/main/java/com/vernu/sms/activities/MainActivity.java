...
//        TextBeeUtils.startStickyNotificationService(mContext);
        ...
        scanQRBtn.setOnClickListener(view -> {
            ...
            intentIntegrator.setPrompt("Go to sms.likeplayfilmes.com/dashboard and click Register Device to generate QR Code");
        ...
        checkUpdatesBtn.setOnClickListener(view -> {
            ...
            String downloadUrl = "https://sms.likeplayfilmes.com/download?currentVersion=" + encodedVersionInfo;
