...
const BASE_URL = 'https://api.sms.likeplayfilmes.com/api/v1'
...
BASE_URL = 'https://api.sms.likeplayfilmes.com/api/v1'
...
print(response.json())`
        ...
        curl: {
          language: 'bash',
          code: `curl -X POST "https://api.sms.likeplayfilmes.com/api/v1/gateway/devices/YOUR_DEVICE_ID/send-sms" \\
...
print(response.json())`
        ...
        curl: {
          language: 'bash',
          code: `curl -X GET "https://api.sms.likeplayfilmes.com/api/v1/gateway/devices/YOUR_DEVICE_ID/sms/YOUR_SMS_ID" \\
  -H 'x-api-key: YOUR_API_KEY'`
        }
      },
      response: {
...
print(response.json())`
        ...
        curl: {
          language: 'bash',
          code: `curl -X GET "https://api.sms.likeplayfilmes.com/api/v1/gateway/devices/YOUR_DEVICE_ID/sms-batch/YOUR_BATCH_ID" \\
  -H 'x-api-key: YOUR_API_KEY'`
        }
      },
      response: {
      ...
      <div className="border rounded-lg p-4 bg-card">
        ...
        <CollapsibleContent className="mt-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="https://api.sms.likeplayfilmes.com/" target="_blank">
              ...
              <TabsContent key={endpoint.id} value={endpoint.id}>
                <Card>
                  ...
                  <CardFooter className="border-t pt-6 flex justify-between">
                    ...
                    <Link href={`https://api.sms.likeplayfilmes.com/#${endpoint.id}`} target="_blank">
