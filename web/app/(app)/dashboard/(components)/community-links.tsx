  ...
  const socials = [
    {
      ...
      name: 'Facebook',
      url: 'https://www.facebook.com/sharer/sharer.php?u=https://sms.likeplayfilmes.com',
    },
    {
      icon: '/images/x.svg',
      name: 'Twitter',
      url: 'https://twitter.com/intent/tweet?url=https://sms.likeplayfilmes.com&text=🚀+Just+discovered+@textbeedotdev+-+an+amazing+SMS+gateway+platform!+Perfect+for+those+who+need+reliable+sms+integration.',
    },
    {
      icon: '/images/linkedin2.svg',
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/sharing/share-offsite/?url=https://sms.likeplayfilmes.com',
    },
    {
      icon: '/images/reddit.svg',
      name: 'Reddit',
      url: 'https://www.reddit.com/submit?url=https://sms.likeplayfilmes.com&title=sms.likeplayfilmes.com+-+Developer-friendly+SMS+Gateway+Platform',
    },
    {
      icon: '/images/whatsapp.svg',
      name: 'WhatsApp',
      url: "https://api.whatsapp.com/send?text=Hey!+Check+out+sms.likeplayfilmes.com+-+it's+a+fantastic+SMS+gateway+platform+perfect+for+those+who+need+reliable+sms+integration+🚀+https://sms.likeplayfilmes.com",
    },
    {
      icon: '/images/telegram.svg',
      name: 'Telegram',
      url: 'https://t.me/share/url?url=https://sms.likeplayfilmes.com&text=🔥+Found+an+awesome+SMS+gateway+platform+-+sms.likeplayfilmes.com!+Great+for+those+who+need+reliable+sms+integration.',
    },
    {
      icon: '/images/gmail.svg',
      name: 'Email',
      url: "mailto:?subject=Check+out+sms.likeplayfilmes.com+-+SMS+Gateway+Platform&body=Hi!%0A%0AI+wanted+to+share+sms.likeplayfilmes.com+with+you+-+it's+an+excellent+SMS+gateway+platform+that's+perfect+for+those+who+need+reliable+sms+integration.%0A%0ACheck+it+out:+https://sms.likeplayfilmes.com%0A%0ABest+regards!",
    },
  ]
    ...
    <>
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-2'>
        ...
        <Card>
          ...
          <CardContent>
            <p className='text-sm text-muted-foreground mb-4'>
              Help others discover sms.likeplayfilmes.com by sharing it with your network.
            </p>
            ...
            >
              <Share2 className='mr-2 h-4 w-4' /> Share sms.likeplayfilmes.com
            </Button>
          </CardContent>
        </Card>
      </div>
        ...
        <DialogContent className='sm:max-w-[600px] min-w-[500px] text-base'>
          <DialogHeader>
            <DialogTitle className='text-primary mb-2 text-2xl font-bold'>
              Share sms.likeplayfilmes.com with Others
            </DialogTitle>
            <p className='text-muted-foreground'>
              Help us grow by sharing sms.likeplayfilmes.com with your friends and
              colleagues!
            </p>
          </DialogHeader>
